        ...
        SubShader {  
                ...
                Pass {  //первый пасс для тени.
                        ...
                        v2f vert (appdata_t v)
                        {
                                ...
                                o.vertex.x = o.vertex.x-0.005*min(480/_ScreenParams.x, 1.0);
								o.vertex.y = o.vertex.y-0.005*min(480/_ScreenParams.x, 1.0);
